...
class EarlyStopping:
    ...
    def __init__(
        ...
        self.best_path = Path(f"{settings.modelsave_folderpath}/V{settings.model_version}/Best cVNP.pt")
        self.local_path = Path(f"{settings.modelsave_folderpath}/V{settings.model_version}/cVNP.pt")
