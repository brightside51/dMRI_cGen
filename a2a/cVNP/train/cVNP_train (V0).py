    ...
    for epoch in range(save_epoch + 1, settings.num_epochs):
        ...
        for p, patient_id in enumerate(settings.train_patient_list):
            ...
            for batch_idx, batch in train_bar:
                ...
                train_logger.experiment.add_scalar("Time | Data Reader", time.perf_counter() - data_time, train_iter)
                ...
                train_logger.experiment.add_scalar("Time | Forward Propagation", time.perf_counter() - model_time, train_iter)
                ...
                train_logger.experiment.add_scalar("Time | Loss Computation", time.perf_counter() - loss_time, train_iter)
                data_time = time.perf_counter()
