...
class EarlyStopping:
    ...
    def __init__(
        ...
        self.best_path = Path(f"{settings.modelsave_folderpath}/V{settings.model_version}/Best 2D CVAE-GAN.pt")
        self.local_path = Path(f"{settings.modelsave_folderpath}/V{settings.model_version}/Local 2D CVAE-GAN.pt")
