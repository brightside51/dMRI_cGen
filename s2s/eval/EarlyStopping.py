...
class EarlyStopping:
    ...
    def __init__(
        ...
        self.best_path = Path(f"{settings.modelsave_folderpath}/V{settings.model_version}/Best fcNN.pt")
        self.local_path = Path(f"{settings.modelsave_folderpath}/V{settings.model_version}/fcNN.pt")
